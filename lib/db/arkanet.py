...
async def on_message(message):
	...
	#self role continetal
		...
		#Arkanet Terminal | Administration | Ip-Tables | virtual-servers | bot | edits | text of truth
		if message.channel.id != 856434834900254731:
			if message.channel.id != 85482998525290086:
				if message.channel.id != 854881723183005708:
					if message.channel.id != 854882460868542474:
						if message.channel.id != 854891098584514580:
